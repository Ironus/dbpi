...
public class Alice {
  ...
  private byte[] cBob; // szyfrogram od Boba
  private byte[] message; // wiadomosc od Boba
  ...
  private void startListening() {
    ...
    try {
      ...
      int cBobSize = dis.readInt();
      cBob = new byte[cBobSize];
      dis.read(cBob, 0, cBobSize);
      System.out.println("[Alice] Odebralam szyfrogram od Boba");

      decipherCode();
      System.out.println("Wiadomosc od Boba to:");
